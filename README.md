...
- [`eduardohitek/uuidg](https://github.com/eduardohitek/uuidg) to generate UUID.

To install them all with `brew`:

```console
brew install fish bat git-delta dog exa fd fzf gh grc kubectx ripgrep eduardohitek/uuidg
```
